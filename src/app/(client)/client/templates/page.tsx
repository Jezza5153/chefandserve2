...
export default async function ClientTemplatesPage({
  ...
  return (
    <div>
      ...
      {templates.length === 0 ? (
        <div className="mt-8 rounded-lg border border-ink-200 bg-white p-6 text-center">
          <p className="text-sm text-ink-500">
            Je hebt nog geen vaste shifts. Een terugkerende dienst spreken we samen af —
            dien een aanvraag in of neem contact op met Chef &amp; Serve.
          </p>
          <Link
            href="/client/request"
