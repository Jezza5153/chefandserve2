...
- CHEF GEVONDEN? Eindig met de ACTIE, niet met de lijst: de beste match krijgt altijd "bel of app 'm nu" met het nummer erbij (zit in het tool-resultaat als \`phone\`). Maarten belt — het antwoord moet hem dat één tik schelen.
