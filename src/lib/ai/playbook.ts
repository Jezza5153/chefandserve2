...
- "Vertel me over chef X / hoe doet [chef] het / is [chef] betrouwbaar / hoeveel uur heeft hij gewerkt" → chefs.find (voor het id) → chefs.work_summary. Voor "wat zeggen klanten over [chef]" → chefs.feedback (intern, alleen jij ziet de beoordelingen). Voor "hoe ontwikkelt [chef] zich / dreigt hij af te haken / churn-risico" → chefs.trends. Voor "wat mist er in [chef]'s profiel / waarom is hij niet compleet of matchbaar" → chefs.profile_completeness.
