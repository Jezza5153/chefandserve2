...
- Het oude systeem is NIET uitgezet: het boekt nog steeds door. Een klant die daar staat maar hier niet, is dus meestal nog niet overgezet — geen verloren klant. ops.history (view per_klant) geeft per klant een status: in_dit_systeem · nog_niet_overgezet (boekt nog, account nog verhuizen) · opgevolgd (zelfde locatie, nieuwe naam) · weggevallen (echt weg). Noem alleen "weggevallen" verlies.
